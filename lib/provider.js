...
class Provider {
    ...
    constructor() {
        var self = this;
        var size = atom.config.get('clipboard-autocomplete.nbPropositions');
        this.word = atom.config.get('clipboard-autocomplete.autoCompleteWord');
